...
public class client {
    public static void main(String[] args) {
        ...
        products.add(new Product("2", "MacBook", 1800, "Apple", "Electronics", 4.8));
        products.add(new Product("3", "AirPods", 200, "Apple", "Electronics", 4.2));
        products.add(new Product("4", "Galaxy Phone", 900, "Samsung", "Electronics", 4.4));
        products.add(new Product("5", "Galaxy Tablet", 700, "Samsung", "Electronics", 4.1));
        products.add(new Product("6", "Dell Laptop", 1200, "Dell", "Electronics", 4.3));
        ...
        products.add(new Product("10", "Xbox Controller", 70, "Microsoft", "Electronics", 4.4));
        ...
        products.add(new Product("18", "Coffee Maker", 150, "Keurig", "Home", 4.3));
        ...
        products.add(new Product("22", "Razer Gaming Mouse", 80, "Razer", "Electronics", 4.4));
        products.add(new Product("23", "Logitech Keyboard", 120, "Logitech", "Electronics", 4.3));
        products.add(new Product("24", "Canon Camera", 950, "Canon", "Electronics", 4.6));
        products.add(new Product("25", "GoPro Camera", 400, "GoPro", "Electronics", 4.5));
        ...
        products.add(new Product("30", "Fitbit Tracker", 180, "Fitbit", "Electronics", 4.1));
        products.add(new Product("31", "Puma Sneakers", 110, "Puma", "Clothing", 4.0));
        ...
        products.add(new Product("35", "Vans Skate Shoes", 85, "Vans", "Clothing", 4.2));
        ...
        products.add(new Product("38", "Robot Vacuum", 320, "Roomba", "Home", 4.4));
        products.add(new Product("39", "Bookshelf", 200, "IKEA", "Furniture", 4.1));
        products.add(new Product("40", "Desk Lamp", 60, "Philips", "Home", 4.0));
        ...
        products.add(new Product("45", "Yoga Mat", 50, "Gaiam", "Sports", 4.1));
        products.add(new Product("46", "Dumbbell Set", 200, "Bowflex", "Sports", 4.6));
        ...
        products.add(new Product("51", "Dining Table", 650, "Ashley", "Furniture", 4.2));
        products.add(new Product("52", "Office Desk", 350, "IKEA", "Furniture", 4.1));
        products.add(new Product("53", "Recliner Chair", 500, "La-Z-Boy", "Furniture", 4.6));
        products.add(new Product("54", "Bed Frame", 400, "Zinus", "Furniture", 4.4));
        products.add(new Product("55", "Nightstand", 120, "IKEA", "Furniture", 4.0));
        ...
        FilterIF appleFilter = new PriceRangeFilter(10,100);
        List<Product> appleProducts = appleFilter.meetCriteria(products);
